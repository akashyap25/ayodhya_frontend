...
import nageshwarnath from '../Assets/nageshwarnath.jpg';

const Temple = () => {
  return (
    <>
      <div className='flex flex-col lg:flex-row lg:space-x-2 justify-center items-center text-center lg:w-2/3 mx-auto p-8 mt-24'>
        <div className='lg:w-1/5 bg-white rounded-lg shadow-lg shadow-orange-500 p-4'>
        ...
        <div className='lg:w-1/5 bg-white rounded-lg shadow-lg shadow-orange-500 p-4 mt-4 lg:mt-0'>
        ...
        <div className='lg:w-1/5 bg-white rounded-lg shadow-lg shadow-orange-500 p-4 mt-4 lg:mt-0'>
          <img src={nageshwarnath} alt='Kanak Bhawan' className='w-full h-auto' />
          <h2 className='text-xl font-semibold mt-2'>Shri Nageshwar Nath Mandir</h2>
          <p className='text-sm font-semibold my-8'>
          The temple of Nageshwarnath is said to have been established by Kush, the son of Rama. Legend is that Kush lost his armlet, while bathing in the Saryu, which was picked up by a Nag-Kanya, who fell in love with him. As she was a devotee of Shiva, Kush erected this temple for her.
          </p>
        </div>
      </div>
    </>
